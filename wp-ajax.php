...
if ( !class_exists( 'WPAjax' ) ) {
	class WPAjax {
		...
		function enqueue_scripts() {
			...
			wp_register_script('transitionEnd',WP_AJAX_PLUGIN_URL . '/js/includes/transition-end.min.js', array(), false, true );
			...
			wp_register_script('jquery-ajaxify', WP_AJAX_PLUGIN_URL . '/js/includes/jquery.ajaxify.js', array('transitionEnd', 'jquery','jquery-address','jquery-form','jquery-imagesloaded'), false, true );
			wp_register_script(WP_AJAX_SCRIPT_UID, WP_AJAX_PLUGIN_URL . '/js/jquery.wp-ajax.js', array('transitionEnd','jquery-ajaxify', 'jquery','jquery-address','jquery-form', 'jquery-imagesloaded'), false, true );
